...
%%%%%%%%%%%%%%%%%%%%%
  ...
  \section{Motivaciones y objetivos}
    \subsection{Objetivo principal}
       Implementar con Python la integración del trapecio para f(x) % MIRAR SI VAMOS A INTRODUCIR
    \subsection{Objetivo específico} 
       Realizar un algoritmo capaz de resolver la integración del trapecio para $ f(x) = \frac{1}{1 + e^{x}}$, x E [1, 6]. % ALGO MÁS AQUÍ, O BORRARLO
  \pagebreak
